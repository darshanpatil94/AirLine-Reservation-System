...
--
-- Table structure for table `N1Flight`
--

DROP TABLE IF EXISTS `N1Flight`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `N1Flight` (
...
--
-- Dumping data for table `N1Flight`
--

LOCK TABLES `N1Flight` WRITE;
/*!40000 ALTER TABLE `N1Flight` DISABLE KEYS */;
INSERT INTO `N1Flight` VALUES ('A1','F','O',NULL),('A2','F','O',NULL),('A3','F','O',NULL),('A4','F','O',''),('B1','F','O',NULL),('B2','F','O',NULL),('B3','F','O',NULL),('B4','F','O',NULL),('C1','F','O',NULL),('C2','F','O',NULL),('C3','F','X','darshan'),('C4','F','X','darshan'),('D1','E','X','darshan'),('D2','E','X','darshan'),('D3','E','O',NULL),('D4','E','O',NULL),('E1','E','O',NULL),('E2','E','O',NULL),('E3','E','O',NULL),('E4','E','O',NULL),('F1','E','O',NULL),('F2','E','O',NULL),('F3','E','O',NULL),('F4','E','O',NULL);
/*!40000 ALTER TABLE `N1Flight` ENABLE KEYS */;
UNLOCK TABLES;
